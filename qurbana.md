...
phases:
    ...
    stages:
      - title: "The Preparation (Tuyobo)"
        ...
        sanctuary_info:
          ...
          description: "The sanctuary (Madbaha) is the Holy of Holies where the entire life of our Lord is presented. It symbolizes heaven with the presence of the Father, Son, and Holy Spirit along with the angels (Eph 2:1-16), like the Holy of Holies of the Jerusalem Temple (Heb 9:4-5). It is Golgotha (Gen 14:18) where Melchizedek worshipped, close to Adam's sepulchre where the Cross was erected. The sanctuary also symbolizes Mt. Sinai (Ex 19:16-25) and Paradise (Rev 2:7)."
          sacred_items:
            ...
            - name: "Chithola (Covering Sheet)"
              malayalam: "ചിതോല"
              image: "/assets/img/sacred-items/chithola_medium.png"
        ...
        veil_info:
          ...
          image: "/assets/img/sacred-items/veil_medium.png"
          description: "The curtain separating the Holy Place indicates the hiddenness of Heaven. As heaven is hidden from the earth, the sanctuary is divided from the main body of the Church by this curtain. The congregation outside the sanctuary, and the representatives of our Lord and the heavenly angels inside the sanctuary, stand and worship. As Christ ascended into heaven and intercedes, the priest stands inside the sanctuary, on the other side of the curtain, and intercedes for the congregation. This curtain is drawn when the priest and the congregation worship God together, thus Heaven and Earth are joined together in worshipping and praying."
        substages:
          - title: "The Vesting of the Priest"
            significance: "The priest puts on seven sacred vestments 'for glory and for beauty' (Exodus 28:2), symbolizing putting on Christ and the 'Armor of God' needed for spiritual struggle. Bishops wear twelve vestments."
            ...
            sacred_items:
              - name: "Cuttanam (Priestly Cap)"
                malayalam: "കുത്താനം"
                image: "/assets/img/sacred-items/cuttanam_medium.png"
                meaning: "The black priestly cap worn on the head, symbolizing authority and the covering of thoughts for God. It represents the mind directed toward heavenly things and submission to divine will."
              - name: "Black Robe (Karathu Kuppayam)"
                malayalam: "കറുത്ത കുപ്പായം"
                image: "/assets/img/sacred-items/black_robe_medium.png"
                meaning: "Denotes the sinful nature of humanity. It reminds us of the fall in the Garden of Eden and the sinful nature of the people whom the priest represents. Black is a mark of sorrow and penitence."
              - name: "Surplice (Alb / White Cassock / Kutino / Chiton)"
                malayalam: "ശ്രുശൂഷ കുപ്പായം"
                image: "/assets/img/sacred-items/surplice_medium.png"
                meaning: "The white robe of incorruption through the purification of the Holy Spirit, symbolizing purity and holiness. 'His clothes were dazzling like the sun' at the Transfiguration (Matthew 17:2), and 'white as snow' at the Resurrection (Matthew 28:3)."
              - name: "Hamnikho (Stole / Oorara / Oorare)"
                malayalam: "ഹാംനിഖോ"
                meaning: "A girdle of strength for defeating enemies (Psalm 18:39-40). It is also the breastplate of righteousness (Exodus 28:4)."
                image: "/assets/img/sacred-items/hamnikho_medium.png"
              - name: "Zunnoro (Girdle / Arrakettu / Zenoro / Soonoro)"
                malayalam: "സുന്നോറോ"
                image: "/assets/img/sacred-items/zunnoro_medium.png"
              ...
              - name: "Zende (Sleeves / Kai-Urrakkal / Zindo)"
                malayalam: "സെന്ദേ"
              ...
              - name: "Phayno (Chasuble / Cope / Kappa / Phaino)"
                malayalam: "ഫായ്നോ"
              ...
              - name: "Msone (Shoes)"
                ...
                meaning: "Symbolize the gospel of peace (Ephesians 6:15), used to trample serpents, scorpions, and all powers of the enemy. The priest dedicates himself for God's service after stamping the powers of Satan under his feet. As his body does not touch the earth, his thoughts also should be above the earth — reminiscent of the Seraphim who covered their feet with wings while worshipping (Isaiah 6:2)."
          - title: "Preparation of the Elements"
            ...
            sacred_items:
              - name: "Lahmo (Sacred Bread)"
                malayalam: "ലാഹ്മോ"
                meaning: "Leavened wheat bread prepared daily with wheat flour, leaven, salt, and water (wheat stands for dust, leaven for air, water, and salt for fire). Our Lord used regular leavened bread — Lahemo or Artos (Greek) — not Pathiro or Azeme at the Last Supper. The leaven is considered a continuation of the same bread given by our Lord to St. John, a tradition from the Church of Persia. The Church uses leavened bread to affirm that the Lord is the life-giving leaven of the Universe."
                image: "/assets/img/sacred-items/lahmo_medium.png"
              - name: "Mazgogo (Sacred Wine)"
                malayalam: "മാസ്ഗോഗോ"
                meaning: "Grape wine mixed with water in the cup. This reminds us that divinity and humanity are united in the person of our Lord Jesus Christ, that our Lord mixed wine with water at the Last Supper, and that blood and water came out when His side was pierced on the Cross, to wash away the sins of all creation."
              ...
              - name: "Pilaso (Paten)"
                ...
                image: "/assets/img/sacred-items/pilaso_medium.png"
              - name: "Kaso (Chalice)"
                malayalam: "കാസോ"
                ...
                image: "/assets/img/sacred-items/kaso_medium.png"
              - name: "Tablitho (Altar Stone)"
                ...
                image: "/assets/img/sacred-items/tablitho_medium.png"
              - name: "Virikootam (Altar Coverings)"
                malayalam: "വിരികൂടം"
                meaning: "The cloth spread over the Tablitho, made of three pieces stitched together: the bottom in red (symbolizing the fiery Universe), the centre in green (the verdant earth), and the top in white (the Holy Church). The Holy vessels containing the Body and Blood of Christ are placed on the white portion, as our Lord gave His Body and Blood to the Church."
                image: "/assets/img/sacred-items/virikootam_medium.png"
              - name: "Kablono (Vessel Coverings)"
                malayalam: "കബ്ലോനോ"
                meaning: "Two pieces of decorated cloth that cover the Paten and Chalice individually, protecting the sacred elements before they are covered together by the Shushepo (Great Veil)."
                image: "/assets/img/sacred-items/kablono_medium.png"
              - name: "Kaukubo (Star)"
                malayalam: "കൗക്കുബോ"
                meaning: "A star-shaped frame placed over the Paten so that the Kablono cloth does not touch the Blessed Bread. It symbolizes the star that appeared and stopped over the manger of the Infant Jesus on the first Christmas day (Matthew 2:9)."
                image: "/assets/img/sacred-items/kaukubo_medium.png"
              - name: "G'murtho (Tongs/Cushion)"
                malayalam: "ഗ്മുർത്തോ"
                meaning: "A small cushion used for cleaning the priest's hands after touching the Holy Bread, ensuring that every fragment of the sacred elements is treated with utmost reverence."
                image: "/assets/img/sacred-items/gmurtho_medium.png"
              - name: "Espoogo (Sponge/Towel)"
                malayalam: "എസ്പൂഗോ"
                meaning: "A piece of cloth or towel used to clean the Holy vessels, the Tharvodo (spoon), and the Kaukubo (Star) after the distribution of communion, ensuring no trace of the sacred elements remains."
                image: "/assets/img/sacred-items/espoogo_medium.png"
          - title: "The Shushepo (ശുശെപ്പോ — Sosappa)"
  ...
  - phase_id: "public-celebration"
    ...
    description: "The public celebration of the liturgy encompasses the proclamation of Scripture and the Eucharistic mysteries, establishing sacred space, preparing the faithful for the divine mystery, and culminating in communion with the Body and Blood of Christ through the invocation of the Holy Spirit."
    card_description: "Procession, proclamation, and Eucharistic prayer"
    subparts:
      - subpart_id: "pre-anaphora"
        title: "Pre-anaphora"
        stages:
              ...
              - title: "The Solemn Entrance"
                ...
                sacred_items:
                  - name: "Dhoopakutty (Censer)"
                    ...
                    meaning: "The vessel which brings forth the sweet smell of incense, representing the Church and the dedication of oneself to God (Eph 5:2). The lower cup represents the earth, the upper cup heaven. The chains represent the Holy Trinity — two for the Son's human and divine natures, one for the Father, one for the Holy Spirit. The 12 bells represent the 12 Apostles, and the 72 links the 72 evangelists. The charcoal represents sinners, fire the Holy Spirit, and frankincense good deeds (Rev 8:3-4). Another interpretation is that the censer is the Blessed Virgin Mother and the fire inside is the blessed divine Child. The censer with incense also symbolizes the gifts of the Magi — gold, frankincense, and myrrh (Psalm 141:2, Rev 8:4)."
                    image: "/assets/img/sacred-items/dhoopakutty_medium.png"
                  - name: "Dhoopam (Incense)"
                    malayalam: "ധൂപം"
                    meaning: "Sweet incense burnt every morning in the Temple (Ex 30:7, Num 16:6). The general understanding is that as the smoke rises, prayer also ascends with it to heaven (Psalm 141:2). It reminds us of our Lord's sacrifice, 'a fragrant offering and sacrifice to God' (Eph 5:2)."
                    image: "/assets/img/sacred-items/vasnam_medium.png"
              ...
              - title: "Ministry of the Word (Epistles & Gospel)"
                ...
                sacred_items:
                  - name: "Marvahtho (Fans)"
                    ...
                    image: "/assets/img/sacred-items/marvahtho_medium.png"
                  - name: "Mani (Bells)"
                    malayalam: "മണി"
                    meaning: "Bells are rung to summon the faithful to worship and to proclaim important occasions during the Qurbana: the Holy birth announcement at the start, the reading of the Gospel, the blessing of the Censer, the celebration of the Shushepo, the blessing of the bread, and the elevation of Paten and Chalice. In ancient times, wooden pieces were used instead of bells. The bell sounds recall the death of our Lord on the wooden Cross and remind us to sign the Cross."
                    image: "/assets/img/sacred-items/mani_medium.png"
                  - name: "Valiya Mani (Church Bell)"
                    malayalam: "വലിയ മണി"
                    meaning: "The large bell hung at the church entrance or bell tower, rung to call the faithful to worship from afar. Its deep, resonant sound carries across the parish, announcing the beginning of the Qurbana and other sacred services. The bell's voice represents the call of God summoning His people to gather as one body."
                    image: "/assets/img/sacred-items/valiya_mani_medium.png"
                  - name: "Msaknsabino (Tabernacle)"
                    malayalam: "മ്സക്ൻസബിനോ"
                    meaning: "A sacred vessel placed on the altar, used to reserve the consecrated Body and Blood of Christ. The reserved sacrament is kept for administering Holy Communion to the sick, the dying, and those unable to attend the Qurbana. The tabernacle represents the dwelling place of God among His people, recalling the Ark of the Covenant in the Holy of Holies."
                    image: "/assets/img/sacred-items/msaknsabino_medium.png"
                  - name: "Momsho (Candles)"
                    malayalam: "മോംശോ"
                    meaning: "Candles show the presence of God and His Saints — 'I am the Light of the World' (John 1:9). Seven candles are based on the golden lamp of the Jerusalem Temple, or twelve representing the Apostles. During the 1st century persecutions, the Qurbana was conducted at night in underground catacombs where the departed were buried, and candles used for light were kept on the tombs. The Church continued this practice even after persecution ended. The melting candle wax, changed into another shape, is like a person who by rebirth in Christ becomes a new creation."
      ...
      - subpart_id: "anaphora"
        title: "Anaphora"
        stages:
          - title: "The Anaphora of St. James — Approaching the Sacred Mystery"
            ...
            image: "/assets/img/anaphora-hand-washing.webp"
            substages:
          ...
          - title: "Kiss of Peace and Lifting of the Veil"
            ...
            substages:
              ...
              - title: "Lifting of the Shushepo (ശുശെപ്പോ)"
              ...
              - title: "Holy Communion of the Faithful"
                ...
                sacred_items:
                  ...
                  - name: "Tharvodo (Spoon)"
                    ...
                    image: "/assets/img/sacred-items/tharvodo_medium.png"

  - phase_id: "post-communion"
    title: "Post-Communion Service"
    malayalam: "സമാപനി ശുശ്രൂഷ"
    description: "The Post-Communion Service marks the conclusion of the Holy Qurbana. The faithful, having received the sacred mysteries, depart with blessings and prayers of thanksgiving, carrying Christ's grace into the world as witnesses of His love and redemptive sacrifice."
    card_description: "Closing prayers, hymns, and blessing"
    stages:
      - title: "Post-Communion Service"
        malayalam: "സമാപനി ശുശ്രൂഷ"
        ...
        substages:
          - title: "Thanksgiving Prayers and Hymns"
            ...
            sacred_items:
              - name: "None required"
                meaning: "The prayers and hymns themselves are the offering of grateful hearts"

          - title: "Promuion-Sedra for the Departed"
            significance: "A prayer is offered for all the faithful who have departed this life, especially those recently deceased and those whose memory is being commemorated. This prayer remembers that the priest does not know if he will return to the altar, and it reminds the congregation of the reality of death and the hope of resurrection."
            theological_meaning: "The Church continues to remember and pray for those who have fallen asleep in Christ, affirming that communion extends beyond the veil of death. This prayer witnesses to the communion of saints and the bond that death cannot break."
            ritual_gesture: "The priest stands before the altar with reverence, his prayers spoken with care for the departed. The congregation joins in silent prayer, remembering their own loved ones and the mortality they share."
            sacred_items:
              - name: "None required"
                meaning: "The memory of the departed and the prayers offered on their behalf are sacred"

          - title: "Final Kouma and Farewell to the Thronos"
            significance: "The priest offers the final blessing (Kouma) and takes leave of the altar (Thronos) with reverence. This marks the formal conclusion of the sacred service, signifying that the priest steps down from his sacred office and returns to the community of the faithful. The priest silently prays words of profound humility: 'I do not know whether I will return to this altar again,' recognizing that only God holds the future and that life itself is a sacred trust."
            theological_meaning: "This farewell to the altar is a meditation on mortality and readiness. The priest's private prayer reminds both him and the community that death can come at any moment—none of us knows the hour of our departure. This awareness inspires the faithful to live in constant readiness and to treasure each opportunity to serve God. The service ends, but its effects continue as the faithful live out the mysteries they have celebrated in their daily lives, prepared always to meet their Creator."
            spiritual_message: "The congregation is reminded of the reality of mortality and the call to spiritual preparedness. Just as the priest does not know if he will return to the altar, neither do the faithful know their final day. This is not spoken in despair, but as a call to live with purpose, gratitude, and deep faith in God's providence."
            ritual_gesture: "The priest bows reverently before the altar, offering the silent prayer of farewell. He then faces the congregation with the final blessing (Kouma), his hands extended in blessing. The congregation receives this blessing with signs of the cross and deep reverence, ready to depart into the world renewed by the Holy mysteries and strengthened by the memory of the priest's humble words about mortality and God's eternal kingdom."
            sacred_items:
              - name: "None required"
